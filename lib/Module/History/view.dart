  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text("Pengiriman Hari Ini"),
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Container(
                            ...
                            height: 25,
                            // color: themeGreen,
                            child: Text("Harus Segera Dikirim",style: DynamicTextStyle.textNormal(fontSize: 13,color: grey900)),
                          ),
                          RowDetail(),
                        ],
                      ),
                                  ...
                                  Container(
                                    ...
                                    children: [
                                      Container(
                                        width: 30,
                                        height: 30,
                                        decoration: RoundedBoxWithShadow
                                            .getDecoration(
                                                color: themeWhite,
                                                radius: 25,
                                                elevation: 1),
                            ...
                            children: [
                              Row(
                                mainAxisAlignment:
                                    MainAxisAlignment.spaceBetween,
                                children: [
                                  Text("Tanggal Pemesanan",style: DynamicTextStyle.textNormal(fontSize: 13,color: grey900),),
                                  Text("Nomer Order",style: DynamicTextStyle.textNormal(fontSize: 13,color: grey900))
                                ],
                              ),
                              SizedBox(
                                height: 5,
                              ...
                              Row(
                                mainAxisAlignment:
                                    MainAxisAlignment.spaceBetween,
                                children: [
                                  Text("Senin, 17 Agustus 2023",style: DynamicTextStyle.textNormal(fontSize: 13,color: grey900)),
                                  Text("#GC-01-8882873837",style: DynamicTextStyle.textNormal(fontSize: 13,color: grey900))
                                ],
                              ),
                            ],
                          ),
